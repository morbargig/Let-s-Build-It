...
var MapService = /** @class */ (function () {
  ...
  MapService.prototype.clearAllOverlays = function () {
    var _a;
    (_a = this.zoneDraws) === null || _a === void 0
      ? void 0
      : _a.forEach(function (zd) {
  ...
  MapService.prototype.drawPolygon = function (polygon, disableZoom) {
    var _this = this;
    if (disableZoom === void 0) {
      disableZoom = false;
    }
    var bounds = new google.maps.LatLngBounds();
    var changedAction = function () {
      var zoneDraw = _this.zoneDraws.find(function (x) {
        return x.shape === polygon;
      });
  ...
  MapService.prototype.drawPolygonByPoints = function (zone, config, disableZoom, editable) {
    ...
    var triangleCoords = zone.points.map(function (res) {
      return new google.maps.LatLng(res.latitude, res.longitude);
    });
    config = config || {
    ...
    var polygon = new google.maps.Polygon(
      __assign({ paths: triangleCoords, editable: !!editable, draggable: !!editable }, config)
    );
  ...
  MapService.prototype.drawCircleByPoint = function (zone, config, disableZoom, editable) {
    ...
    var circle = new google.maps.Circle(
      __assign({ center: triangleCoords[0], editable: !!editable, draggable: !!editable }, config)
    );
