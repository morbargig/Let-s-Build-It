...
@Component({
  selector: 'prx-rental-force-close-modal',
  templateUrl: './rental-force-close-modal.component.html',
  styleUrls: ['./rental-force-close-modal.component.scss'],
})
export class RentalForceCloseModalComponent implements OnInit {
  ...
  public formSubmitted(formGroup: FormGroup) {
    ...
    const model = {
      ...
      subject: AlertSubject.RentalForceClose,
      status: form.status,
