...
import { FixedDiscountsModel, ChargesModel, DiscountsModel } from '../../../../@shared/models/discounts-and-charges.model';
...
export class DiscountsAndChargesService extends BaseParentHttpService<number, DiscountsModel> {
  ...
  public getCharges(parentId: number, messages: ErrorMessages = null, entityName: string = null): Observable<ChargesModel> {
    return this.http.get<ChargesModel>(`${this.newApiUrl(parentId, 'Charges')}`, this.getOptions(messages, entityName));
  }
  public updateCharges(parentId: number, model: ChargesModel, messages: ErrorMessages = null, entityName: string = null): Observable<ChargesModel> {
    return this.http.post<ChargesModel>(`${this.newApiUrl(parentId, 'Charges')}`, model, this.getOptions(messages, entityName));
  }
  ...
  public getFixedDiscounts(parentId: number, messages: ErrorMessages = null, entityName: string = null): Observable<FixedDiscountsModel> {
    return this.http.get<FixedDiscountsModel>(`${this.newApiUrl(parentId, 'FixedDiscounts')}`, this.getOptions(messages, entityName));
  }
  public updateFixedDiscounts(parentId: number, model: FixedDiscountsModel, messages: ErrorMessages = null, entityName: string = null): Observable<FixedDiscountsModel> {
    return this.http.post<FixedDiscountsModel>(`${this.newApiUrl(parentId, 'FixedDiscounts')}`, model, this.getOptions(messages, entityName));
  }

  public deleteDiscounts(parentId: number, modelsArr: number[], messages: ErrorMessages = null, entityName: string = null) {
