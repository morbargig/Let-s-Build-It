...
export class HomeComponent implements OnInit {
  ...
  //     description: "You can trust what you're buying will speed up your development time by 200%",
  //     image: 'reliable.svg',
  //   },
  // ];
  ...
  //     .subscribe((strategy) => this.route.queryParams.subscribe((params) => this.redirect(params)));
  // }
